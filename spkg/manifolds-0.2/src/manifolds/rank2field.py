...
class SymBilinFormField(TensorField):
    ...
    - ``manifold`` -- the manifold on which the field of symmetric bilinear 
      forms  is defined
    ...
    For the manifold's default frame, the components are accessed with the square brackets::
    ...
    A symmetric bilinear form acts on vector pairs::
        ...
        sage: m = Manifold(2, 'M')
        sage: c_xy = Chart(m, 'x y', 'xy_coord')
    ...
    def _new_comp(self, frame_name): 
        ...
        return CompFullySym(self.manifold, 2, frame_name)
    ...
    def _new_instance(self):
        ...
        """
        return SymBilinFormField(self.manifold)
...
class EndomorphismField(TensorField):
    ...
    - ``manifold`` -- the manifold on which the field of endomorphisms is 
      defined
    - ``name`` -- (default: None) name given to the field
    - ``latex_name`` -- (default: None) LaTeX symbol to denote the field; 
      if none is provided, the LaTeX symbol is set to ``name``
    ...
    def _new_instance(self):
        ...
        """
        return EndomorphismField(self.manifold)
...
class AutomorphismField(EndomorphismField):
    ...
    - ``manifold`` -- the manifold on which the field of automorphisms is 
      defined
    - ``name`` -- (default: None) name given to the field
    - ``latex_name`` -- (default: None) LaTeX symbol to denote the field; 
      if none is provided, the LaTeX symbol is set to ``name``
    ...
    """
    def __init__(self, manifold, name=None, latex_name=None):
        EndomorphismField.__init__(self, manifold, name, latex_name)
    ...
    def _new_instance(self):
        ...
        """
        return AutomorphismField(self.manifold)
    ...
    def inverse(self):
        ...
        if self._inverse is None:
            ...
            self._inverse = AutomorphismField(manif, inv_name, inv_latex_name)
            for frame_name in self.components:
                if frame_name[-2:] == '_b':
                    # coordinate basis
                    chart_name = frame_name[:-2]
                else:
                    chart_name = manif.def_chart.name  #!# to be improved
                try:    
                    mat_self = matrix(
                ...
                cinv = Components(manif, 2, frame_name)
...
class IdentityMap(AutomorphismField):
    ...
    - ``manifold`` -- the manifold on which the identity map is 
      defined
    ...
    """
    def __init__(self, manifold, name=None, latex_name=None):
        AutomorphismField.__init__(self, manifold)
        if name is None:
            self.name = 'Id'
        else:    
            self.name = name
        ...
        self.comp() # Initializing the components in the manifold's default frame
    ...
    def _repr_(self):
        ...
        if self.name is not None:
            description += " '%s'" % self.name
        description += " in the tangent spaces of the " + str(self.manifold)
        return description
    ...
    def _new_comp(self, frame_name): 
        ...
        return KroneckerDelta(self.manifold, frame_name)

    def comp(self, frame_name=None):
        r"""
        ...
        if frame_name not in self.components:
            self.components[frame_name] = KroneckerDelta(self.manifold, 
                                                         frame_name)
