#
# v0.6 version of comp.py corrected from the symmetrization bug in tensor
# products of the type a*a (a = 1-index set of components)
# (the corrected piece of code is at lines 1129-1137)
# Date: 19 Jan 2015
#
r"""
Components
